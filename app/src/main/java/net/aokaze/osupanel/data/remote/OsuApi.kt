...
/**
 * All osu! API v2 endpoints — counterpart of the Flutter
 * `AuthRemoteDataSource` (osu! part). All requests go through the
 * interceptor that injects `Authorization: Bearer` and handles 401 refresh.
 */
interface OsuApi {
